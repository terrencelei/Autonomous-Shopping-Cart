...
CENTER_REACQUIRE_S  = 1
CENTER_START_RPM    = 1
CENTER_MIN_RUN_RPM  = 1
CENTER_KICK_RPM  =10
CENTER_KICK_RELEASE_TICKS = 20
CENTER_SEARCH_KICK_RPM =10.0
CENTER_SEARCH_MAX_RPM = 1
...
STALL_MAX_RPM           = 0.9  # safety cap for the ramp-up search
